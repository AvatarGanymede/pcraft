...
export const ListWorkflowsRenderer: PcraftRenderer = ({ args, result, status }) => {
...
export const ListWorkflowStepsRenderer: PcraftRenderer = ({ args, result, status }) => {
  ...
  return (
    <PcraftRow
      Icon={IconList}
      title="Pcraft: List Workflow Steps"
      summary={
        <span className="inline-flex items-center gap-1.5">
          {workflowId && (
            <>
...
export const ListTasksRenderer: PcraftRenderer = ({ args, result, status }) => {
...
export const ListRelatedTasksRenderer: PcraftRenderer = ({ args, result, status }) => {
  ...
  return (
    <PcraftRow
      Icon={IconLink}
      title="Pcraft: List Related Tasks"
      summary={
        <span className="inline-flex items-center gap-1.5">
          {taskId && (
            <>
...
export const ListAgentsRenderer: PcraftRenderer = ({ result, status }) => {
  const items = pickArray<AgentItem>(result, "agents") ?? [];
  const total = pickNumber(result, "total") ?? items.length;
  return (
    <PcraftRow
      Icon={IconRobot}
      title="Pcraft: List Agents"
...
export const ListExecutorProfilesRenderer: PcraftRenderer = ({ args, result, status }) => {
  ...
  return (
    <PcraftRow
      Icon={IconServer}
      title="Pcraft: List Executor Profiles"
      summary={
        <span className="inline-flex items-center gap-1.5">
          {executorId && (
            <>
...
export const ListTaskDocumentsRenderer: PcraftRenderer = ({ args, result, status }) => {
  ...
  return (
    <PcraftRow
      Icon={IconFiles}
      title="Pcraft: List Task Documents"
      summary={
        <span className="inline-flex items-center gap-1.5">
          {taskId && (
            <>
