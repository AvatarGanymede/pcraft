// Parsing helpers for Pcraft MCP tool calls.
//
// Tool names arrive prefixed by the agent runtime:
//   - Claude Code:  `mcp__pcraft__<tool>_pcraft`
//   - Codex:        `pcraft/<tool>_pcraft`
//   - Bare:         `<tool>_pcraft`
//
// `extractPcraftStem` strips the namespace and the trailing `_pcraft` suffix so
...
export function isPcraftTool(toolName: string | undefined): boolean {
  return extractPcraftStem(toolName) !== null;
}
