...
import { IdChip, PcraftBody, PcraftRow, KeyValueRow, SummaryDot, TaskStateBadge } from "./shared";
...
export const CreateTaskRenderer: PcraftRenderer = ({ args, result, status }) => {
...
export const UpdateTaskRenderer: PcraftRenderer = ({ args, result, status }) => {
...
export const MoveTaskRenderer: PcraftRenderer = ({ args, result, status }) => {
  const taskId = pickString(args, "task_id");
...
export const MessageTaskRenderer: PcraftRenderer = ({ args, result, status }) => {
  const taskId = pickString(args, "task_id");
  const prompt = pickString(args, "prompt");
