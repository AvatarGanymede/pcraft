...
import {
  uploadFrontendLog,
  type ImprovePcraftBootstrapResponse,
} from "@/lib/api/domains/improve-pcraft-api";
 ...
 */
export async function buildImprovePcraftDescription(
  description: string,
  bootstrap: ImprovePcraftBootstrapResponse | null,
  captureLogs: boolean,
): Promise<string> {
