// Package improvepcraft exposes the HTTP endpoints that bootstrap a hidden
// improve-pcraft workflow and capture recent backend/frontend logs into a
...
const bundlePrefix = "pcraft-improve-"
...
// CleanupStaleBundles removes pcraft-improve-* directories under the OS temp
...
// validateBundleDir refuses paths that do not match the pcraft-improve-* temp
