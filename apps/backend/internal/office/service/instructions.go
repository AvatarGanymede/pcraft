...
func (s *Service) ListInstructions(ctx context.Context, agentInstanceID string) ([]*models.InstructionFile, error) {
	return s.repo.ListInstructions(ctx, agentInstanceID)
}

// GetInstruction returns a single instruction file by agent and filename.
func (s *Service) GetInstruction(ctx context.Context, agentInstanceID, filename string) (*models.InstructionFile, error) {
	return s.repo.GetInstruction(ctx, agentInstanceID, filename)
}

// UpsertInstruction creates or updates an instruction file.
func (s *Service) UpsertInstruction(
...
func (s *Service) DeleteInstruction(ctx context.Context, agentInstanceID, filename string) error {
...
func (s *Service) CreateDefaultInstructions(ctx context.Context, agentInstanceID, role string) error {
