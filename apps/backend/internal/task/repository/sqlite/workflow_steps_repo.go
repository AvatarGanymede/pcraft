...
// initWorkflowExtensionsSchema creates workflow template/step tables and seeds defaults.
func (r *Repository) initWorkflowExtensionsSchema() error {
...
// Stubbed: workflow engine removed in pcraft slim build.
func getKanbanTemplate() (*models.WorkflowTemplate, error) {
	return nil, fmt.Errorf("workflows: kanban template not available in pcraft slim build")
}
