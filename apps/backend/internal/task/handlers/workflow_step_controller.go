...
type WorkflowStepController struct {
	svc *service.WorkflowStepService
}

func NewWorkflowStepController(svc *service.WorkflowStepService) *WorkflowStepController {
	return &WorkflowStepController{svc: svc}
}
...
func (c *WorkflowStepController) ListTemplates(ctx context.Context) (*ListTemplatesResponse, error) {
...
func (c *WorkflowStepController) GetTemplate(ctx context.Context, id string) (*GetTemplateResponse, error) {
...
func (c *WorkflowStepController) ListStepsByWorkflow(ctx context.Context, req ListStepsRequest) (*ListStepsResponse, error) {
...
func (c *WorkflowStepController) ListStepsByWorkspace(ctx context.Context, workspaceID string) (*ListStepsResponse, error) {
...
func (c *WorkflowStepController) GetStep(ctx context.Context, id string) (*GetStepResponse, error) {
...
func (c *WorkflowStepController) CreateStepsFromTemplate(ctx context.Context, req CreateStepsFromTemplateRequest) error {
...
func (c *WorkflowStepController) CreateStep(ctx context.Context, req CreateStepRequest) (*GetStepResponse, error) {
...
func (c *WorkflowStepController) UpdateStep(ctx context.Context, req UpdateStepRequest) (*GetStepResponse, error) {
...
func (c *WorkflowStepController) DeleteStep(ctx context.Context, id string) error {
...
func (c *WorkflowStepController) ReorderSteps(ctx context.Context, req ReorderStepsRequest) error {
...
func (c *WorkflowStepController) ListHistoryBySession(ctx context.Context, req ListHistoryRequest) (*ListHistoryResponse, error) {
...
func (c *WorkflowStepController) ExportWorkflow(ctx context.Context, workflowID string) (*models.WorkflowExport, error) {
...
func (c *WorkflowStepController) ExportWorkflows(ctx context.Context, workspaceID string, workflowIDs []string) (*models.WorkflowExport, error) {
	return c.svc.ExportWorkflows(ctx, workspaceID, workflowIDs)
}

// ImportWorkflows imports workflows into a workspace.
func (c *WorkflowStepController) ImportWorkflows(ctx context.Context, req ImportWorkflowsRequest) (*service.ImportResult, error) {
