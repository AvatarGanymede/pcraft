...
Use the ask_user_question_pcraft MCP tool to get answers before proceeding.

First check if a plan already exists using the get_task_plan_pcraft MCP tool.
...
Save the plan using the create_task_plan_pcraft or update_task_plan_pcraft MCP tool.
