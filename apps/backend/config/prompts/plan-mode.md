...
WORKFLOW:
1. Read the current plan using the get_task_plan_pcraft MCP tool.
...
5. Save your changes using the update_task_plan_pcraft MCP tool (or create_task_plan_pcraft if no plan exists yet).
